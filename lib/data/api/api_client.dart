...
class ApiClient extends GetxService {
  ...
  Future<Response> sendAdvertice(id, serviceId, details, address, img) async {
    print("P");
    print("Pressed");
    ...
    return await postMultipartData("/api/v1/customer/serviceorder/place", _body,
        [MultipartBody('image', img)]);
    // await Http.post(
    //     Uri.parse(
    //         "${AppConstants.BASE_URL}/api/v1/customer/serviceorder/place"),
    //     //https://elsouqalmubasher.com/api/v1/serviceorder/place
